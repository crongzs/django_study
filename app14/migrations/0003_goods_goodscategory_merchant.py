# Generated by Django 3.0.3 on 2020-03-12 08:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('merchant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='app14.Merchant', verbose_name='所属商家')),
            ],
        ),
        migrations.CreateModel(
            name='Goods',
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='goods_list', to='app14.GoodsCategory')),
            ],
        ),
    ]
